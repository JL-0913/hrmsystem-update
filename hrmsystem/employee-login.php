...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stored_hash = '$2y$10$mfJTLZ8xW.bSWV930q0zMuSepZokJvk8nPfWI9Pc1xe4w40flxeES'; // Replace with the real hash from the database if needed
        ...
        $error_message = ""; // Display a message for incorrect login
    }
